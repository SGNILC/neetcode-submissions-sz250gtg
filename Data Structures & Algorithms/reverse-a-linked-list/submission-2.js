...
class Solution {
    ...
    reverseList(head) {
        ...
        /**
         * Time complexity: O(n) b/c it is dependent of nodes in list
         * Space Complexity: O(n) b/c we need to get to the base case, thus the stack will be the size of the array
         */
        ...
        // O(n) + O(1)
        let newHead = head // O(1)
        if (head.next != null){ // O(1)
            newHead = this.reverseList(head.next) //O(n)
